...
RESULT_FILE = "clock_glitch_results_apprcycle_rand.csv"
...
try:
    ...
    ext_offsets =    (
        list(range(30, 45)) + 
        list(range(42, 60)) +  # early AND/store region
        list(range(60, 70)) +  # strongest computation/leakage region
        list(range(78, 90)) +    # later XOR/store/return region
